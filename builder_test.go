...
func TestBuilder(t *testing.T) {
	...
	tests := []*testV{
		...
		{psql.B().Select("Field").From("Table").Where(&psql.Like{Field: psql.F("Field"), Like: "prefix%"}), `SELECT "Field" FROM "Table" WHERE ("Field" LIKE 'prefix%' ESCAPE '\')`},
...
func TestBuilderArgs(t *testing.T) {
	...
	tests := []*testV{
		...
		{psql.B().Select("Field").From("Table").Where(&psql.Like{Field: psql.F("Field"), Like: "prefix%"}), `SELECT "Field" FROM "Table" WHERE ("Field" LIKE ? ESCAPE '\')`},
